...
export default async function CollectionDetailPage({ params, searchParams }: PageProps) {
  ...
  if (query) {
    const response = await searchCollection(name, { query, limit });
    ...
    const response = await fetchCollectionRecords(name, { limit, offset });
    total = response.total;
        ...
        <div className="space-y-4">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <RecordsTable collection={name} fields={viewFields} records={records} searchMode={searchMode} />
